...
# START INJECTION | tmpl_api_primitives(Primitives)
    ...
    cdef cppclass h_c_mbool_t "mds::api::const_managed_type_handle<mds::api::kind::BOOL>":
        h_c_mbool_t()
        h_rfield_bool_t field_in(h_record_type_t&, h_istring_t&, bool) except+
        uint64_t hash1()

    cdef h_mbool_t managed_bool_type_handle "mds::api::managed_type_handle<mds::api::kind::BOOL>"()
    cdef h_c_mbool_t const_managed_bool_type_handle "mds::api::managed_type_handle<mds::api::kind::BOOL>"()
    ...
    cdef cppclass h_c_mbyte_t "mds::api::const_managed_type_handle<mds::api::kind::BYTE>":
        h_c_mbyte_t()
        h_rfield_byte_t field_in(h_record_type_t&, h_istring_t&, bool) except+
        uint64_t hash1()

    cdef h_mbyte_t managed_byte_type_handle "mds::api::managed_type_handle<mds::api::kind::BYTE>"()
    cdef h_c_mbyte_t const_managed_byte_type_handle "mds::api::managed_type_handle<mds::api::kind::BYTE>"()
    ...
    cdef cppclass h_c_mubyte_t "mds::api::const_managed_type_handle<mds::api::kind::UBYTE>":
        h_c_mubyte_t()
        h_rfield_ubyte_t field_in(h_record_type_t&, h_istring_t&, bool) except+
        uint64_t hash1()

    cdef h_mubyte_t managed_ubyte_type_handle "mds::api::managed_type_handle<mds::api::kind::UBYTE>"()
    cdef h_c_mubyte_t const_managed_ubyte_type_handle "mds::api::managed_type_handle<mds::api::kind::UBYTE>"()
    ...
    cdef cppclass h_c_mshort_t "mds::api::const_managed_type_handle<mds::api::kind::SHORT>":
        h_c_mshort_t()
        h_rfield_short_t field_in(h_record_type_t&, h_istring_t&, bool) except+
        uint64_t hash1()

    cdef h_mshort_t managed_short_type_handle "mds::api::managed_type_handle<mds::api::kind::SHORT>"()
    cdef h_c_mshort_t const_managed_short_type_handle "mds::api::managed_type_handle<mds::api::kind::SHORT>"()
    ...
    cdef cppclass h_c_mushort_t "mds::api::const_managed_type_handle<mds::api::kind::USHORT>":
        h_c_mushort_t()
        h_rfield_ushort_t field_in(h_record_type_t&, h_istring_t&, bool) except+
        uint64_t hash1()

    cdef h_mushort_t managed_ushort_type_handle "mds::api::managed_type_handle<mds::api::kind::USHORT>"()
    cdef h_c_mushort_t const_managed_ushort_type_handle "mds::api::managed_type_handle<mds::api::kind::USHORT>"()
    ...
    cdef cppclass h_c_mint_t "mds::api::const_managed_type_handle<mds::api::kind::INT>":
        h_c_mint_t()
        h_rfield_int_t field_in(h_record_type_t&, h_istring_t&, bool) except+
        uint64_t hash1()

    cdef h_mint_t managed_int_type_handle "mds::api::managed_type_handle<mds::api::kind::INT>"()
    cdef h_c_mint_t const_managed_int_type_handle "mds::api::managed_type_handle<mds::api::kind::INT>"()
    ...
    cdef cppclass h_c_muint_t "mds::api::const_managed_type_handle<mds::api::kind::UINT>":
        h_c_muint_t()
        h_rfield_uint_t field_in(h_record_type_t&, h_istring_t&, bool) except+
        uint64_t hash1()

    cdef h_muint_t managed_uint_type_handle "mds::api::managed_type_handle<mds::api::kind::UINT>"()
    cdef h_c_muint_t const_managed_uint_type_handle "mds::api::managed_type_handle<mds::api::kind::UINT>"()
    ...
    cdef cppclass h_c_mlong_t "mds::api::const_managed_type_handle<mds::api::kind::LONG>":
        h_c_mlong_t()
        h_rfield_long_t field_in(h_record_type_t&, h_istring_t&, bool) except+
        uint64_t hash1()

    cdef h_mlong_t managed_long_type_handle "mds::api::managed_type_handle<mds::api::kind::LONG>"()
    cdef h_c_mlong_t const_managed_long_type_handle "mds::api::managed_type_handle<mds::api::kind::LONG>"()
    ...
    cdef cppclass h_c_mulong_t "mds::api::const_managed_type_handle<mds::api::kind::ULONG>":
        h_c_mulong_t()
        h_rfield_ulong_t field_in(h_record_type_t&, h_istring_t&, bool) except+
        uint64_t hash1()

    cdef h_mulong_t managed_ulong_type_handle "mds::api::managed_type_handle<mds::api::kind::ULONG>"()
    cdef h_c_mulong_t const_managed_ulong_type_handle "mds::api::managed_type_handle<mds::api::kind::ULONG>"()
    ...
    cdef cppclass h_c_mfloat_t "mds::api::const_managed_type_handle<mds::api::kind::FLOAT>":
        h_c_mfloat_t()
        h_rfield_float_t field_in(h_record_type_t&, h_istring_t&, bool) except+
        uint64_t hash1()

    cdef h_mfloat_t managed_float_type_handle "mds::api::managed_type_handle<mds::api::kind::FLOAT>"()
    cdef h_c_mfloat_t const_managed_float_type_handle "mds::api::managed_type_handle<mds::api::kind::FLOAT>"()
    ...
    cdef cppclass h_c_mdouble_t "mds::api::const_managed_type_handle<mds::api::kind::DOUBLE>":
        h_c_mdouble_t()
        h_rfield_double_t field_in(h_record_type_t&, h_istring_t&, bool) except+
        uint64_t hash1()

    cdef h_mdouble_t managed_double_type_handle "mds::api::managed_type_handle<mds::api::kind::DOUBLE>"()
    cdef h_c_mdouble_t const_managed_double_type_handle "mds::api::managed_type_handle<mds::api::kind::DOUBLE>"()
